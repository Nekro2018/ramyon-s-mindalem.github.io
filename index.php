		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Команда Переводчиков<br>
							 Ramen S Mindalem</h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
							Вся наша команда вас любит и желает приятного прочтения под вкусную тарелочку рамена с миндалем!
							</p>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									<div class="build-ico-button">
										<div class="build-ico-os">
											<img alt="Windows" src="https://ramensmindalem.files.wordpress.com/2022/07/mj-knbyuu94.webp" style='height: 100%; width: 100%; object-fit: contain'/>
											<img alt="Linux"   src="https://ramensmindalem.files.wordpress.com/2022/07/mj-knbyuu94.webp" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
											<img alt="Linux"   src="https://ramensmindalem.files.wordpress.com/2022/07/mj-knbyuu94.webp" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
											<img alt="FreeBSD" src="https://ramensmindalem.files.wordpress.com/2022/07/mj-knbyuu94.webp" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
										</div>
									</div>
									<a href="https://t.me/+ECnqYHSP6E83NGM6">
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(https://ltdfoto.ru/images/2022/07/05/f621b656-cde8-45d6-bb00-72308bb0549784eec495db19d59b.jpg) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 У нас есть свой дискорд сервер, присоединяйся!
								</p>
							</div>
							<a href="https://discord.gg/HWyhj9wBc9" target="_blank">
